...
export declare function addSymbolToNgModuleRoutingMetadata(source: ts.SourceFile, ngModulePath: string, componentName: string, importPath: string | null, options: ModuleOptions): any;
export declare function addDialogToComponentMetadata(source: ts.SourceFile, componentPath: string, name: string, singleName: string, singleModelName: string, relativePathToComponent: string): any;
/**
